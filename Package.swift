...
let package = Package(
    ...
    targets: [
        .target(
            name: "Web3Core",
            dependencies: ["BigInt", .product(name: "secp256k1", package: "secp256k1.swift"), "CryptoSwift"]
        ),
        .target(
            name: "web3swift",
            dependencies: ["Web3Core", "BigInt", .product(name: "secp256k1", package: "secp256k1.swift")],
            resources: [
